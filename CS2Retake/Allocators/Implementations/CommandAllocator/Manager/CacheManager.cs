...
namespace CS2Retake.Allocators.Implementations.CommandAllocator.Manager
{
    public class CacheManager
    {
        ...
        public (string? primaryWeapon, string? secondaryWeapon, int? awpChance) GetFullBuyWeapons(CCSPlayerController player, CsTeam team)
        {
            ...
            _ = this._fullBuyPrimaryCacheT.TryGetValue(player.SteamID, out string? terroristPrimary);
            _ = this._fullBuySecondaryCacheT.TryGetValue(player.SteamID, out string? terroristSecondary);
            _ = this._fullBuyAWPChanceCacheT.TryGetValue(player.SteamID, out int terroristAwpChance);

            return (terroristPrimary, terroristSecondary, terroristAwpChance);
        }
